...
public class VfxUIGUI : ShaderGUI
{
	public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
	{
		...
		MaterialProperty _MAINROTATIONSPEED 	= ShaderGUI.FindProperty("_MAINROTATIONSPEED", properties);
		...
		materialEditor.ShaderProperty(_MAINROTATIONSPEED, _MAINROTATIONSPEED.displayName);
		...
		MaterialProperty _Stencil = ShaderGUI.FindProperty("_Stencil", properties);
		MaterialProperty _StencilOp = ShaderGUI.FindProperty("_StencilOp", properties);
		MaterialProperty _StencilWriteMask = ShaderGUI.FindProperty("_StencilWriteMask", properties);
		MaterialProperty _StencilReadMask = ShaderGUI.FindProperty("_StencilReadMask", properties);
		MaterialProperty _ColorMask = ShaderGUI.FindProperty("_ColorMask", properties);
		...
		materialEditor.ShaderProperty(_StencilWriteMask, _StencilWriteMask.displayName);
		materialEditor.ShaderProperty(_StencilReadMask, _StencilReadMask.displayName);
